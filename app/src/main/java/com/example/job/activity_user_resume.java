...
public class activity_user_resume extends AppCompatActivity {
...
//                    //     toolbar.setTitle("Shop");
                    Intent intent = new Intent(activity_user_resume.this, UserDashboard.class);
...
//                    Toast.makeText(Home.this, "Search Click", Toast.LENGTH_SHORT).show();
 ...
 //                   finish();
                ...
                case R.id.navigation_profile:
                    ...
                    Intent intent2 = new Intent(activity_user_resume.this, UserProfile.class);
