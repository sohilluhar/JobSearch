...
public class activity_resume_others extends AppCompatActivity {
...
//                    //     toolbar.setTitle("Shop");
                    Intent intent = new Intent(activity_resume_others.this, UserDashboard.class);
...
//                    Toast.makeText(Home.this, "Search Click", Toast.LENGTH_SHORT).show();
                ...
                case R.id.navigation_upcomingEvent:
                    Intent intent1 = new Intent(activity_resume_others.this, UserGoingEvent.class);
                    startActivity(intent1);
                    finish();
                    return true;
                case R.id.navigation_resume:
           //         Intent intent3= new Intent(activity_resume_others.this, resume_dashboard.class);
             //       startActivity(intent3);
               //     finish();
                    return true;
                case R.id.navigation_profile:
                    Intent intent2 = new Intent(activity_resume_others.this, UserProfile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resume_others);
...
//        Glide.with(this).load(Common.currentuser.getProfileurl())..into(viewHolder.imgevent);
        ...
        btnresumepersonal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_others.this,activity_resume_personal.class);
                startActivity(intent);
            }
        });
        btnresumeeducation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_others.this,activity_resume_educational.class);
                startActivity(intent);
            }
        });
        btnresumeexperiance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_others.this,activity_resume_experiance.class);
                startActivity(intent);
            }
        });
        btnresumeproject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_others.this,activity_resume_project.class);
                startActivity(intent);
            }
        });
        btnresumeextracurricular.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_others.this,activity_resume_extracuricular.class);
                startActivity(intent);
            }
        });
        btnresumeothers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
         //       Intent intent=new Intent(activity_resume_others.this,activity_resume_others.class);
          //      startActivity(intent);
            }
        });
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_resume_others.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//                            progressDialog.dismiss();
                            Toast.makeText(activity_resume_others.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void updateuserprofile() {
        ...
        editor.apply();
        Toast.makeText(activity_resume_others.this, "Profile Updated", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(activity_resume_others.this, UserDashboard.class);
        startActivity(intent);
        finish();
    }
