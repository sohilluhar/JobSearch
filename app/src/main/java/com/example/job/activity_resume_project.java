...
public class activity_resume_project extends AppCompatActivity {
...
//                    //     toolbar.setTitle("Shop");
                    Intent intent = new Intent(activity_resume_project.this, UserDashboard.class);
...
//                    Toast.makeText(Home.this, "Search Click", Toast.LENGTH_SHORT).show();
                ...
                case R.id.navigation_upcomingEvent:
                    Intent intent1 = new Intent(activity_resume_project.this, UserGoingEvent.class);
                    startActivity(intent1);
                    finish();
                    return true;
                case R.id.navigation_resume:
                //   Intent intent3= new Intent(activity_resume_project.this, resume_dashboard.class);
                ...
                case R.id.navigation_profile:
                    ...
                    Intent intent2 = new Intent(activity_resume_project.this, UserProfile.class);
...
//        Glide.with(this).load(Common.currentuser.getProfileurl())..into(viewHolder.imgevent);
       /* try {
        ...
        btnresumepersonal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_project.this,activity_resume_personal.class);
                startActivity(intent);
        ...
        btnresumeeducation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_project.this,activity_resume_educational.class);
                startActivity(intent);
        ...
        btnresumeexperiance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_project.this,activity_resume_experiance.class);
                startActivity(intent);
        ...
        btnresumeproject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
          //      Intent intent=new Intent(activity_resume_project.this,activity_resume_project.class);
            //    startActivity(intent);
        ...
        btnresumeextracurricular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_project.this,activity_resume_extracuricular.class);
                startActivity(intent);
        ...
        btnresumeothers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_project.this,activity_resume_others.class);
                startActivity(intent);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_resume_project.this, MainActivity.class);
                startActivity(intent);
                finish();
...
//                            progressDialog.dismiss();
                            Toast.makeText(activity_resume_project.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void updateuserprofile() {
        ...
        editor.apply();
        Toast.makeText(activity_resume_project.this, "Profile Updated", Toast.LENGTH_SHORT).show();
