...
public  class activity_resume_personal extends AppCompatActivity {
    final int PICK_IMAGE_REQUEST = 71;
    FirebaseStorage storage;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference dbUserRef = database.getReference("resume");
    ...
    CircularImageView imguserprofile,personal_image;
    ...
    EditText personal_fullname,personal_address,personal_contact,personal_mail,personal_careerobjective;
...
//                    //     toolbar.setTitle("Shop");
                    Intent intent = new Intent(activity_resume_personal.this, UserDashboard.class);
...
//                    Toast.makeText(Home.this, "Search Click", Toast.LENGTH_SHORT).show();
                ...
                case R.id.navigation_upcomingEvent:
                    Intent intent1 = new Intent(activity_resume_personal.this, UserGoingEvent.class);
                    startActivity(intent1);
                    finish();
                    return true;
                case R.id.navigation_resume:
                 // Intent intent3= new Intent(activity_resume_personal.this, resume_dashboard.class);
                  //  startActivity(intent3);
                   // finish();
                    return true;
                case R.id.navigation_profile:
                    Intent intent2 = new Intent(activity_resume_personal.this, UserProfile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imguserprofile = findViewById(R.id.imguserprofile);//sadiq update
        ...
        personal_image = findViewById(R.id.personal_image);//sadiq update
       // personal_image = findViewById(R.id.personal_image);
        personal_fullname = findViewById(R.id.personal_fullname);//sdiq update
        personal_address = findViewById(R.id.personal_address);//sadiqupdate
        personal_contact = findViewById(R.id.personal_contact);//sadiqupdate
        personal_mail = findViewById(R.id.personal_mail);//sadiqupdate
        personal_careerobjective = findViewById(R.id.personal_careerobjective);//sadiqupdate
...
//        Glide.with(this).load(Common.currentuser.getProfileurl())..into(viewHolder.imgevent);
        try {
            if (!Common.currentuser.getProfileurl().equalsIgnoreCase(""))
                Picasso.get().load(Common.currentuser.getProfileurl()).into(personal_image);
        }catch (Exception e){}
        ...
        btnresumepersonal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             //   Intent intent=new Intent(activity_resume_personal.this,activity_resume_personal.class);
              //  startActivity(intent);
            }
        });
        btnresumeeducation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_personal.this,activity_resume_educational.class);
                startActivity(intent);
            }
        });
        btnresumeexperiance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_personal.this,activity_resume_experiance.class);
                startActivity(intent);
            }
        });
        btnresumeproject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_personal.this,activity_resume_project.class);
                startActivity(intent);
            }
        });
        btnresumeextracurricular.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_personal.this,activity_resume_extracuricular.class);
                startActivity(intent);
            }
        });
        btnresumeothers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_personal.this,activity_resume_others.class);
                startActivity(intent);
            }
        });
...
//        currentuserpersonalemail.setText(Common.currentuser.getEmail());
       personal_fullname.setText(Common.currentuser.getPersonal_fullname());
        personal_address.setText(Common.currentuser.getPersonal_address());
        personal_contact.setText(Common.currentuser.getPersonal_contact());
        personal_mail.setText(Common.currentuser.getPersonal_mail());
        personal_careerobjective.setText(Common.currentuser.getPersonal_careerobjective());
...
//                Intent intent = new Intent(activity_resume_personal.this, MainActivity.class);
//                startActivity(intent);
//                finish();
//            }
//        });
        dbUserRef.addListenerForSingleValueEvent
                (new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                      //  resume currentuser = dataSnapshot.getValue(resume.class);
...
//                            progressDialog.dismiss();
                            Toast.makeText(activity_resume_personal.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
...
//                Common.currentuser.getRequestedconnection(),
                ...
                personal_fullname.getText().toString(),
                personal_address.getText().toString(),
                personal_contact.getText().toString(),
                personal_mail.getText().toString(),
                personal_careerobjective.getText().toString(),
              imgurl
//                Common.currentuser.getGoingevent(),
//                Common.currentuser.getConnection(),
//                Common.currentuser.getPendingconnection(),
//                Common.currentuser.getRequestedconnection(),
        ...
        dbUserRef.child(Common.currentuser.getUserphone()).setValue(tmp);

        Toast.makeText(activity_resume_personal.this, "Profile Updated", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(activity_resume_personal.this, UserDashboard.class);
        startActivity(intent);
        finish();
    }
