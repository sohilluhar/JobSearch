...
public class ViewPendingConnection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pending_connection);
        users = new ArrayList<>();
        ...
        dbUserRef.child("pendingconnection").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
...
//        print(list);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rvUserspendingconnection);
