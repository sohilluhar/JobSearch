...
public class activity_resume_experiance extends AppCompatActivity {
...
//                    //     toolbar.setTitle("Shop");
                    Intent intent = new Intent(activity_resume_experiance.this, UserDashboard.class);
...
//                    Toast.makeText(Home.this, "Search Click", Toast.LENGTH_SHORT).show();
                ...
                case R.id.navigation_upcomingEvent:
                    Intent intent1 = new Intent(activity_resume_experiance.this, UserGoingEvent.class);
                    startActivity(intent1);
                    finish();
                    return true;
                case R.id.navigation_resume:
                //  Intent intent3= new Intent(activity_resume_experiance.this, resume_dashboard.class);
                  //  startActivity(intent3);
                    //finish();
                    return true;
                case R.id.navigation_profile:
                    Intent intent2 = new Intent(activity_resume_experiance.this, UserProfile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resume_experiance);
...
//        Glide.with(this).load(Common.currentuser.getProfileurl())..into(viewHolder.imgevent);
     /*   try {
        ...
        btnresumepersonal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_experiance.this,activity_resume_personal.class);
                startActivity(intent);
            }
        });
        btnresumeeducation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_experiance.this,activity_resume_educational.class);
                startActivity(intent);
            }
        });
        btnresumeexperiance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             //   Intent intent=new Intent(activity_resume_experiance.this,activity_resume_experiance.class);
             //   startActivity(intent);
            }
        });
        btnresumeproject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity_resume_experiance.this,activity_resume_project.class);
                startActivity(intent);
            }
        });
        btnresumeextracurricular.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                  Intent intent=new Intent(activity_resume_experiance.this,activity_resume_extracuricular.class);
                  startActivity(intent);
            }
        });
        btnresumeothers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            //    Intent intent=new Intent(activity_resume_experiance.this,activity_resume_others.class);
            //    startActivity(intent);
            }
        });
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_resume_experiance.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//                            progressDialog.dismiss();
                            Toast.makeText(activity_resume_experiance.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void updateuserprofile() {
        ...
        editor.apply();
        Toast.makeText(activity_resume_experiance.this, "Profile Updated", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(activity_resume_experiance.this, UserDashboard.class);
        startActivity(intent);
        finish();
    }
