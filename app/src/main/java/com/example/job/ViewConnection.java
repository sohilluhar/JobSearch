...
public class ViewConnection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbUserRef.child("connection").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
...
//        print(list);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rvUsersTotalconnection);
